        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProjectPageId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardTasks_ProjectPages_ProjectPageId",
                        column: x => x.ProjectPageId,
                        principalTable: "ProjectPages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardTasks_Users_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BoardTasks_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedPageId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_BoardTasks_BoardtaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskHistories_BoardTasks_BoardTaskId",
                        column: x => x.BoardTaskId,
                        principalTable: "BoardTasks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardTasks_AssignedToId",
                table: "BoardTasks",
                column: "AssignedToId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardTasks_CreatedById",
                table: "BoardTasks",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_BoardTasks_ProjectPageId",
                table: "BoardTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistories_BoardTaskId",
                table: "TaskHistories",
                column: "BoardTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNotifications_UserId_Provider",
