...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest caesar.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`caesar.client.esproj`).
